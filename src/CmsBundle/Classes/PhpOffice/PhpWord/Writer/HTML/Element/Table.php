...
class Table extends AbstractElement
{
    ...
    {
        if (!$this->element instanceof \App\CmsBundle\Classes\PhpOffice\PhpWord\Element\Table) {
            return '';
        }
    ...
    private function getTableStyle($tableStyle = null)
    {
        ...
        if (is_string($tableStyle)) {
            ...
            $style = ' style="';
            if ($tableStyle->getLayout() == \App\CmsBundle\Classes\PhpOffice\PhpWord\Style\Table::LAYOUT_FIXED) {
                $style .= 'table-layout: fixed;';
            } elseif ($tableStyle->getLayout() == \App\CmsBundle\Classes\PhpOffice\PhpWord\Style\Table::LAYOUT_AUTO) {
