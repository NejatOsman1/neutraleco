...
namespace App\CmsBundle\Classes\PhpOffice\PhpWord\Writer\ODText\Style;
...
class Section extends AbstractStyle
{
    ...
    {
        /** @var \App\CmsBundle\Classes\PhpOffice\PhpWord\Style\Section $style Type hint */
        $style = $this->getStyle();
        if (!$style instanceof \App\CmsBundle\Classes\PhpOffice\PhpWord\Style\Section) {
            return;
        }
