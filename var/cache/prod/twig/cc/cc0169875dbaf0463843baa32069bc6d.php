...
class __TwigTemplate_a6f04259e3e70825721f9811ab2bfdc0 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["Metatag"]) {
                // line 43
                echo "            ";
                if ((((twig_get_attribute($this->env, $this->source, $context["Metatag"], "key", [], "any", false, false, false, 43) == "og:type") && twig_test_empty(twig_get_attribute($this->env, $this->source, $context["Metatag"], "value", [], "any", false, false, false, 43))) && !twig_in_filter($context["Metatag"], ($context["parsedBundleTags"] ?? null)))) {
                    // line 44
                    echo "                <meta ";
...
";
        // line 49
        if (((($context["foundOgImage"] ?? null) == false) &&  !twig_test_empty(twig_get_attribute($this->env, $this->source, ($context["Page"] ?? null), "image", [], "any", false, false, false, 49)))) {
            // line 50
...
";
    ...
    {
        return new Source("", "@Cms/page/metadata.html.twig", "/var/www/vhosts/neutral.eco/httpdocs/src/CmsBundle/Resources/views/page/metadata.html.twig");
    }
}
