...
namespace App\CmsBundle\Classes\PhpOffice\PhpWord\Writer\ODText\Part;

use App\CmsBundle\Classes\PhpOffice\Common\XMLWriter;
use App\CmsBundle\Classes\PhpOffice\PhpWord\Element\AbstractContainer;
use App\CmsBundle\Classes\PhpOffice\PhpWord\Element\Image;
use App\CmsBundle\Classes\PhpOffice\PhpWord\Element\Table;
use App\CmsBundle\Classes\PhpOffice\PhpWord\Element\Text;
use App\CmsBundle\Classes\PhpOffice\PhpWord\Element\TextRun;
use App\CmsBundle\Classes\PhpOffice\PhpWord\Element\TrackChange;
use App\CmsBundle\Classes\PhpOffice\PhpWord\PhpWord;
use App\CmsBundle\Classes\PhpOffice\PhpWord\Style;
use App\CmsBundle\Classes\PhpOffice\PhpWord\Style\Font;
use App\CmsBundle\Classes\PhpOffice\PhpWord\Style\Paragraph;
use App\CmsBundle\Classes\PhpOffice\PhpWord\Style\Table as TableStyle;
use App\CmsBundle\Classes\PhpOffice\PhpWord\Writer\ODText\Element\Container;
use App\CmsBundle\Classes\PhpOffice\PhpWord\Writer\ODText\Style\Paragraph as ParagraphStyleWriter;
...
class Content extends AbstractPart
{
    ...
    private function writeAutoStyles(XMLWriter $xmlWriter)
    {
        ...
        foreach ($this->autoStyles as $element => $styles) {
            $writerClass = 'CmsBundle\\Classes\\PhpOffice\\PhpWord\\Writer\\ODText\\Style\\' . $element;
            foreach ($styles as $style) {
                /** @var \App\CmsBundle\Classes\PhpOffice\PhpWord\Writer\ODText\Style\AbstractStyle $styleWriter Type hint */
     ...
     *
     * @param \App\CmsBundle\Classes\PhpOffice\PhpWord\PhpWord $phpWord
     */
     ...
     *
     * @param \App\CmsBundle\Classes\PhpOffice\PhpWord\Element\AbstractContainer $container
    ...
    private function getContainerStyle($container, &$paragraphStyleCount, &$fontStyleCount)
    {
        ...
        foreach ($elements as $element) {
            if ($element instanceof TextRun) {
                ...
                /** @var \App\CmsBundle\Classes\PhpOffice\PhpWord\Style\Table $style */
                $style = $element->getStyle();
                if ($style === null) {
     ...
     *
     * @param \App\CmsBundle\Classes\PhpOffice\PhpWord\Element\Text $element
     * @param int $paragraphStyleCount
     * @param int $fontStyleCount
     */
     ...
     * @param \App\CmsBundle\Classes\PhpOffice\PhpWord\Element\AbstractElement[] $trackedChanges
     */
