...
namespace App\CmsBundle\Classes\PhpOffice\PhpWord\Shared;

use App\CmsBundle\Classes\PhpOffice\PhpWord\Element\AbstractContainer;
use App\CmsBundle\Classes\PhpOffice\PhpWord\Element\Row;
use App\CmsBundle\Classes\PhpOffice\PhpWord\Element\Table;
use App\CmsBundle\Classes\PhpOffice\PhpWord\Settings;
use App\CmsBundle\Classes\PhpOffice\PhpWord\SimpleType\Jc;
use App\CmsBundle\Classes\PhpOffice\PhpWord\SimpleType\NumberFormat;
use App\CmsBundle\Classes\PhpOffice\PhpWord\Style\Paragraph;
...
class Html
{
     ...
     *
     * @param \App\CmsBundle\Classes\PhpOffice\PhpWord\Element\AbstractContainer $element Where the parts need to be added
     ...
     * @param \App\CmsBundle\Classes\PhpOffice\PhpWord\Element\AbstractContainer $element object to add an element corresponding with the node
    ...
    protected static function parseNode($node, $element, $styles = array(), $data = array())
    {
        ...
        if (isset($nodes[$node->nodeName])) {
            ...
            $method = "parse{$method}";
            $newElement = call_user_func_array(array('CmsBundle\Classes\PhpOffice\PhpWord\Shared\Html', $method), $arguments);
     ...
     *
     * @param \DOMNode $node
     * @param \App\CmsBundle\Classes\PhpOffice\PhpWord\Element\AbstractContainer $element
     * @param array $styles
     * @param array $data
     */
     ...
     * @param \App\CmsBundle\Classes\PhpOffice\PhpWord\Element\AbstractContainer $element
     * @param array &$styles
     * @return \App\CmsBundle\Classes\PhpOffice\PhpWord\Element\TextRun
     */
     ...
     *
     * @param \DOMNode $node
     * @param \App\CmsBundle\Classes\PhpOffice\PhpWord\Element\Table $element
     * @param array &$styles
     * @return Row $element
     */
     ...
     * @param \App\CmsBundle\Classes\PhpOffice\PhpWord\Element\Table $element
     * @param array &$styles
     * @return \App\CmsBundle\Classes\PhpOffice\PhpWord\Element\Cell|\PhpOffice\PhpWord\Element\TextRun $element
     */
            ...
            switch (trim($cKey)) {
                ...
                case 'line-height':
                    ...
                    if (preg_match('/([0-9]+\.?[0-9]*[a-z]+)/', $cValue, $matches)) {
                        ...
                        $spacingLineRule = \App\CmsBundle\Classes\PhpOffice\PhpWord\SimpleType\LineSpacingRule::EXACT;
                        $spacing = Converter::cssToTwip($matches[1]);
                    } elseif (preg_match('/([0-9]+)%/', $cValue, $matches)) {
                        //matches percentages
                        $spacingLineRule = \App\CmsBundle\Classes\PhpOffice\PhpWord\SimpleType\LineSpacingRule::AUTO;
                ...
                case 'width':
                    if (preg_match('/([0-9]+[a-z]+)/', $cValue, $matches)) {
                        ...
                        $styles['unit'] = \App\CmsBundle\Classes\PhpOffice\PhpWord\SimpleType\TblWidth::TWIP;
                    } elseif (preg_match('/([0-9]+)%/', $cValue, $matches)) {
                        $styles['width'] = $matches[1] * 50;
                        $styles['unit'] = \App\CmsBundle\Classes\PhpOffice\PhpWord\SimpleType\TblWidth::PERCENT;
                    } elseif (preg_match('/([0-9]+)/', $cValue, $matches)) {
                        $styles['width'] = $matches[1];
                        $styles['unit'] = \App\CmsBundle\Classes\PhpOffice\PhpWord\SimpleType\TblWidth::AUTO;
                    }
                    break;
                case 'border':
     ...
     * @param \App\CmsBundle\Classes\PhpOffice\PhpWord\Element\AbstractContainer $element
     *
     * @return \App\CmsBundle\Classes\PhpOffice\PhpWord\Element\Image
     **/
        ...
        foreach ($node->attributes as $attribute) {
            switch ($attribute->name) {
                ...
                case 'width':
                    ...
                    $style['width'] = $width;
                    $style['unit'] = \App\CmsBundle\Classes\PhpOffice\PhpWord\Style\Image::UNIT_PX;
                    break;
                case 'height':
                    ...
                    foreach ($styleattr as $attr) {
                        if (strpos($attr, ':')) {
                            ...
                            switch ($k) {
                                case 'float':
                                    if (trim($v) == 'right') {
                                        $style['hPos'] = \App\CmsBundle\Classes\PhpOffice\PhpWord\Style\Image::POS_RIGHT;
                                        $style['hPosRelTo'] = \App\CmsBundle\Classes\PhpOffice\PhpWord\Style\Image::POS_RELTO_PAGE;
                                        $style['pos'] = \App\CmsBundle\Classes\PhpOffice\PhpWord\Style\Image::POS_RELATIVE;
                                        $style['wrap'] = \App\CmsBundle\Classes\PhpOffice\PhpWord\Style\Image::WRAP_TIGHT;
                                        $style['overlap'] = true;
                                    }
                                    if (trim($v) == 'left') {
                                        $style['hPos'] = \App\CmsBundle\Classes\PhpOffice\PhpWord\Style\Image::POS_LEFT;
                                        $style['hPosRelTo'] = \App\CmsBundle\Classes\PhpOffice\PhpWord\Style\Image::POS_RELTO_PAGE;
                                        $style['pos'] = \App\CmsBundle\Classes\PhpOffice\PhpWord\Style\Image::POS_RELATIVE;
                                        $style['wrap'] = \App\CmsBundle\Classes\PhpOffice\PhpWord\Style\Image::WRAP_TIGHT;
                                        $style['overlap'] = true;
    ...
    /**
     * Transforms a HTML/CSS alignment into a \App\CmsBundle\Classes\PhpOffice\PhpWord\SimpleType\Jc
     *
