...
use App\CmsBundle\Classes\PhpOffice\PhpWord\Element\AbstractContainer as ContainerElement;
use App\CmsBundle\Classes\PhpOffice\PhpWord\Element\AbstractElement as Element;
use App\CmsBundle\Classes\PhpOffice\PhpWord\Element\TextBreak as TextBreakElement;
...
class Container extends AbstractElement
{
     ...
     * @var string
     */
    protected $namespace = 'CmsBundle\\Classes\\PhpOffice\\PhpWord\\Writer\\Word2007\\Element';
    ...
    public function write()
    {
        ...
        if ($writeLastTextBreak) {
            ...
            /** @var \App\CmsBundle\Classes\PhpOffice\PhpWord\Writer\Word2007\Element\AbstractElement $writer Type hint */
