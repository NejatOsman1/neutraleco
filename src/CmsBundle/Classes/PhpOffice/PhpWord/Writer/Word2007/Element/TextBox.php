...
use App\CmsBundle\Classes\PhpOffice\PhpWord\Writer\Word2007\Style\TextBox as TextBoxStyleWriter;
...
class TextBox extends Image
{
    ...
    public function write()
    {
        ...
        if (!$element instanceof \App\CmsBundle\Classes\PhpOffice\PhpWord\Element\TextBox) {
            return;
        }
