jQuery(function() {
	jQuery("#justified_gallery_iNCSbV").justifiedGallery({
	...
	.on('jg.complete', function(){
			var pswp_iNCSbV = SGGinitPhotoSwipeFromDOM('#justified_gallery_iNCSbV',{title: true, share: true, history: false, uid: 'iNCSbV' })
	});

	var galleries = [];
	var gallery = jQuery("#justified_gallery_C7SlfM");
	jQuery(window).scroll(function() {
		if ( galleries.length >= 1  ) {
			...
			if( scroll_bottom >= gallery_bottom ) {
				...
				var image_html = $("#load_more_holder_C7SlfM").html(images).text();
