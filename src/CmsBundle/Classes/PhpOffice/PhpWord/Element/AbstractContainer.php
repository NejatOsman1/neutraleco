 ...
 *
 * @method \App\CmsBundle\Classes\PhpOffice\PhpWord\Element\OLEObject addObject(string $source, mixed $style = null) deprecated, use addOLEObject instead
 *
 * @since 0.10.0
 */
abstract class AbstractContainer extends AbstractElement
{
     ...
     *
     * @param int $index
     * @return \App\CmsBundle\Classes\PhpOffice\PhpWord\Element\AbstractElement|null
     */
    ...
    public function removeElement($toRemove)
    {
        ...
        } elseif ($toRemove instanceof \App\CmsBundle\Classes\PhpOffice\PhpWord\Element\AbstractElement) {
     ...
     * @param mixed $paragraphStyle
     *
     * @return \App\CmsBundle\Classes\PhpOffice\PhpWord\Element\Footnote
     *
     * @codeCoverageIgnore
     */
