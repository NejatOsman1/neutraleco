...
abstract class AbstractStyle
{
     ...
     *
     * @param \App\CmsBundle\Classes\PhpOffice\PhpWord\Style\AbstractStyle $substyleObject
    ...
    protected function setObjectVal($value, $styleName, &$style)
    {
        ...
        if (is_array($value)) {
            /** @var \App\CmsBundle\Classes\PhpOffice\PhpWord\Style\AbstractStyle $style Type hint */
