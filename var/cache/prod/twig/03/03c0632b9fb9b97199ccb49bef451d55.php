...
class __TwigTemplate_2866c9b405ee046ca08cc5b7ec5524e7 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 2
        if (((array_key_exists("pagination", $context) && (twig_get_attribute($this->env, $this->source, ($context["pagination"] ?? null), "count", [], "any", false, false, false, 2) > 0)) && (twig_get_attribute($this->env, $this->source, ($context["pagination"] ?? null), "totalpages", [], "any", false, false, false, 2) > 0))) {
            // line 3
            echo "\t";
...
\t\t\t";
            ...
            if ((twig_get_attribute($this->env, $this->source, ($context["pagination"] ?? null), "page", [], "any", false, false, false, 10) == 1)) {
                echo " disabled";
            }
...
\t\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
                ...
                if ((twig_get_attribute($this->env, $this->source, ($context["pagination"] ?? null), "page", [], "any", false, false, false, 14) == $context["i"])) {
                    echo " active";
                }
                echo "\"><a class=\"page-link\" href=\"";
...
\t\t\t";
            ...
            if ((twig_get_attribute($this->env, $this->source, ($context["pagination"] ?? null), "totalpages", [], "any", false, false, false, 18) == twig_get_attribute($this->env, $this->source, ($context["pagination"] ?? null), "page", [], "any", false, false, false, 18))) {
                echo " disabled";
            }
            echo "\"><a class=\"page-link\" href=\"";
...
";
    ...
    {
        return new Source("", "@TrinityNeutral/backend/pagination.html.twig", "/var/www/vhosts/neutral.eco/httpdocs/src/Trinity/NeutralBundle/Resources/views/backend/pagination.html.twig");
    }
}
