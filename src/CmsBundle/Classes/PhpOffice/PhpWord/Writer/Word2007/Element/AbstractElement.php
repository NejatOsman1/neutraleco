...
abstract class AbstractElement
{
     ...
     * Element
     *
     * @var \App\CmsBundle\Classes\PhpOffice\PhpWord\Element\AbstractElement
     */
    private $element;
     ...
     * @param \App\CmsBundle\Classes\PhpOffice\PhpWord\Element\AbstractElement $element
     * @param bool $withoutP
     */
     ...
     * Get element
     *
     * @return \App\CmsBundle\Classes\PhpOffice\PhpWord\Element\AbstractElement
     */
     ...
     *
     * @uses \App\CmsBundle\Classes\PhpOffice\PhpWord\Writer\Word2007\Element\PageBreak::write()
     */
    ...
    private function writeTextStyle($styleType)
    {
        ...
        $class = "App\CmsBundle\\Classes\\PhpOffice\\PhpWord\\Writer\\Word2007\\Style\\{$styleType}";
        $styleObject = $this->element->$method();

        /** @var \App\CmsBundle\Classes\PhpOffice\PhpWord\Writer\Word2007\Style\AbstractStyle $styleWriter Type Hint */
