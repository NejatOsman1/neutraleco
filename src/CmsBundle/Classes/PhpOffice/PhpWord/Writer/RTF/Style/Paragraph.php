...
namespace App\CmsBundle\Classes\PhpOffice\PhpWord\Writer\RTF\Style;
...
class Paragraph extends AbstractStyle
{
    ...
    {
        $style = $this->getStyle();
        if (!$style instanceof \App\CmsBundle\Classes\PhpOffice\PhpWord\Style\Paragraph) {
            return '';
        }
    ...
    /**
     * Writes an \App\CmsBundle\Classes\PhpOffice\PhpWord\Style\Indentation
     *
    ...
    {
        if (isset($indent) && $indent instanceof \App\CmsBundle\Classes\PhpOffice\PhpWord\Style\Indentation) {
