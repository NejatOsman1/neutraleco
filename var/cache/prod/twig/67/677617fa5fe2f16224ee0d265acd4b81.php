...
class __TwigTemplate_b920106c90127424f7b19fec31519a8e extends Template
{
    private $source;
    private $macros = [];
          ...
          <div class=\"card\">
            ...
            if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["b"], "config", [], "any", false, true, false, 92), "buttons", [], "any", true, true, false, 92)) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["button"]) {
                    ...
                    echo "\" ";
                    if ((twig_get_attribute($this->env, $this->source, $context["button"], "target", [], "any", true, true, false, 95) && (twig_get_attribute($this->env, $this->source, $context["button"], "target", [], "any", false, false, false, 95) != "null"))) {
                        echo " target=\"";
...
";
    ...
    {
        return new Source("", "@Cms/blocks/framework_cards.html.twig", "/var/www/vhosts/neutral.eco/httpdocs/src/CmsBundle/Resources/views/blocks/framework_cards.html.twig");
    }
}
