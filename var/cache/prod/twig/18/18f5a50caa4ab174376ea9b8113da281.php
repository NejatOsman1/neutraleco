...
class __TwigTemplate_8382ccec62c9f7dfbe219ebb97f20cb6 extends Template
{
    private $source;
    private $macros = [];
...
\t\t";
        ...
        echo "\" ";
        if ((twig_get_attribute($this->env, $this->source, ($context["Question"] ?? null), "required", [], "any", false, false, false, 12) && (twig_get_attribute($this->env, $this->source, ($context["Question"] ?? null), "hidden", [], "any", false, false, false, 12) == false))) {
            echo "required=\"true\"";
        }
        echo " name=\"form[";
...
\t\t";
    ...
    {
        return new Source("", "@TrinityForms/elements/email.html.twig", "/var/www/vhosts/neutral.eco/httpdocs/src/Trinity/FormsBundle/Resources/views/elements/email.html.twig");
    }
}
