...
class Field extends Text
{
    ...
    public function write()
    {
        ...
        if (!$element instanceof \App\CmsBundle\Classes\PhpOffice\PhpWord\Element\Field) {
            return;
        }
    ...
    private function writeDefault(\PhpOffice\PhpWord\Element\Field $element)
    {
        ...
        if ($element->getText() != null) {
            if ($element->getText() instanceof \App\CmsBundle\Classes\PhpOffice\PhpWord\Element\TextRun) {
     ...
     * @param \App\CmsBundle\Classes\PhpOffice\PhpWord\Element\Field $element
     */
