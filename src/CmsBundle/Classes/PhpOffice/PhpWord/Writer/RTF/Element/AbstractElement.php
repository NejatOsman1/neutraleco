...
namespace App\CmsBundle\Classes\PhpOffice\PhpWord\Writer\RTF\Element;

use App\CmsBundle\Classes\PhpOffice\Common\Text as CommonText;
use App\CmsBundle\Classes\PhpOffice\PhpWord\Element\AbstractElement as Element;
use App\CmsBundle\Classes\PhpOffice\PhpWord\Escaper\Rtf;
use App\CmsBundle\Classes\PhpOffice\PhpWord\Settings;
use App\CmsBundle\Classes\PhpOffice\PhpWord\Style;
use App\CmsBundle\Classes\PhpOffice\PhpWord\Style\Font as FontStyle;
use App\CmsBundle\Classes\PhpOffice\PhpWord\Style\Paragraph as ParagraphStyle;
use App\CmsBundle\Classes\PhpOffice\PhpWord\Writer\AbstractWriter;
use App\CmsBundle\Classes\PhpOffice\PhpWord\Writer\HTML\Element\AbstractElement as HTMLAbstractElement;
use App\CmsBundle\Classes\PhpOffice\PhpWord\Writer\RTF\Style\Font as FontStyleWriter;
use App\CmsBundle\Classes\PhpOffice\PhpWord\Writer\RTF\Style\Paragraph as ParagraphStyleWriter;
...
abstract class AbstractElement extends HTMLAbstractElement
{
     ...
     * Font style
     *
     * @var \App\CmsBundle\Classes\PhpOffice\PhpWord\Style\Font
     */
    private $fontStyle;
     ...
     * Paragraph style
     *
     * @var \App\CmsBundle\Classes\PhpOffice\PhpWord\Style\Paragraph
     */
    ...
    {
        /** @var \App\CmsBundle\Classes\PhpOffice\PhpWord\Writer\RTF $parentWriter Type hint */
        $parentWriter = $this->parentWriter;

        /** @var \App\CmsBundle\Classes\PhpOffice\PhpWord\Element\Text $element Type hint */
