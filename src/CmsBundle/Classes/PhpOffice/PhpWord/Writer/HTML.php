...
class HTML extends AbstractWriter implements WriterInterface
{
    ...
    public function __construct(PhpWord $phpWord = null)
    {
        ...
        foreach ($this->parts as $partName) {
            $partClass = 'CmsBundle\\Classes\\PhpOffice\\PhpWord\\Writer\\HTML\\Part\\' . $partName;
            if (class_exists($partClass)) {
                /** @var \App\CmsBundle\Classes\PhpOffice\PhpWord\Writer\HTML\Part\AbstractPart $part Type hint */
                $part = new $partClass();
