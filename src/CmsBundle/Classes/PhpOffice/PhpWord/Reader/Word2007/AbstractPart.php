...
namespace App\CmsBundle\Classes\PhpOffice\PhpWord\Reader\Word2007;

use App\CmsBundle\Classes\PhpOffice\Common\XMLReader;
...
abstract class AbstractPart
{
     ...
     * @param \App\CmsBundle\Classes\PhpOffice\PhpWord\Element\AbstractContainer $parent
    ...
    protected function readTable(XMLReader $xmlReader, \DOMElement $domNode, $parent, $docPart = 'document')
    {
        ...
        /** @var \App\CmsBundle\Classes\PhpOffice\PhpWord\Element\Table $table Type hint */
