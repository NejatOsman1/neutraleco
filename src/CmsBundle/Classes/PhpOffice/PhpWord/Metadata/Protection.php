...
use App\CmsBundle\Classes\PhpOffice\PhpWord\SimpleType\DocProtect;
...
class Protection
{
    ...
    /**
     * Cryptographic Hashing Algorithm (see constants defined in \App\CmsBundle\Classes\PhpOffice\PhpWord\Shared\Microsoft\PasswordEncoder)
     *
     * @var string
     */
     ...
     *
     * @param string $editing Any value of \App\CmsBundle\Classes\PhpOffice\PhpWord\SimpleType\DocProtect
     * @return self
     */
