...
class __TwigTemplate_59e71f51c81696312949037ad78444f9dbb1d73facf037e7c678c33b448a06e2 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["Question"]) {
                // line 43
                echo "\t\t\t\t\t\t";
                if (((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["Question"], "position", [], "any", false, false, false, 43), 0)) && (0 !== twig_compare(($context["firstField"] ?? null), true)))) {
                    // line 44
                    echo "\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t<div class=\"row\">
\t\t\t\t\t\t";
...
\t\t\t\t";
            // line 65
            if ((twig_get_attribute($this->env, $this->source, ($context["config"] ?? null), "show_clear", [], "any", true, true, false, 65) && ((null === twig_get_attribute($this->env, $this->source, ($context["Form"] ?? null), "hideClearButton", [], "any", false, false, false, 65)) || (0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["Form"] ?? null), "hideClearButton", [], "any", false, false, false, 65), 0))))) {
                // line 66
...
";
    ...
    {
        return new Source("", "@TrinityForms/default/form.html.twig", "/var/www/html/src/Trinity/FormsBundle/Resources/views/default/form.html.twig");
    }
}
