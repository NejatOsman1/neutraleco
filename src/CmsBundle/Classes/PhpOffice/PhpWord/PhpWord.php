...
use App\CmsBundle\Classes\PhpOffice\PhpWord\Element\Section;
...
class PhpWord
{
     ...
     *
     * @var \App\CmsBundle\Classes\PhpOffice\PhpWord\Element\Section[]
     */
    ...
    public function __construct()
    {
        ...
        foreach ($collections as $collection) {
            $class = 'CmsBundle\\Classes\\PhpOffice\\PhpWord\\Collection\\' . $collection;
        ...
        foreach ($metadata as $meta) {
            $class = 'CmsBundle\\Classes\\PhpOffice\\PhpWord\\Metadata\\' . $meta;
    ...
    public function __call($function, $args)
    {
        ...
        if (in_array($function, $addCollection)) {
            ...
            /** @var \App\CmsBundle\Classes\PhpOffice\PhpWord\Collection\AbstractCollection $collectionObject */
        ...
        if (in_array($function, $addStyle)) {
            return forward_static_call_array(array('CmsBundle\\Classes\\PhpOffice\\PhpWord\\Style', $function), $args);
        }
     ...
     *
     * @return \App\CmsBundle\Classes\PhpOffice\PhpWord\Metadata\DocInfo
     */
     ...
     * Get protection
     *
     * @return \App\CmsBundle\Classes\PhpOffice\PhpWord\Metadata\Protection
     * @since 0.12.0
     ...
     * Get compatibility
     *
     * @return \App\CmsBundle\Classes\PhpOffice\PhpWord\Metadata\Compatibility
     * @since 0.12.0
     */
     ...
     * Get compatibility
     *
     * @return \App\CmsBundle\Classes\PhpOffice\PhpWord\Metadata\Settings
     * @since 0.14.0
     */
     ...
     * Get all sections
     *
     * @return \App\CmsBundle\Classes\PhpOffice\PhpWord\Element\Section[]
     */
     ...
     *
     * @param int $index
     * @return \App\CmsBundle\Classes\PhpOffice\PhpWord\Element\Section|null
     */
     ...
     * @return \App\CmsBundle\Classes\PhpOffice\PhpWord\Style\Paragraph
     */
     ...
     * @deprecated 0.12.0
     *
     * @param \App\CmsBundle\Classes\PhpOffice\PhpWord\Metadata\DocInfo $documentProperties
     *
     * @return self
     *
     * @codeCoverageIgnore
