...
class __TwigTemplate_b8bad70f333c5595cd432ea7ae4479e7 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t";
            // line 226
            if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["project"] ?? null), "project_certificate", [], "any", false, false, false, 226), "key", [], "any", false, false, false, 226) == 4)) {
                // line 227
...
\t";
        ...
        // line 242
        echo "\t";
        if ((twig_length_filter($this->env, ($context["similar_projects"] ?? null)) > 0)) {
            // line 243
...
";
    ...
    {
        return new Source("", "@TrinityNeutral/front/projects/view-project-detail.html.twig", "/var/www/vhosts/neutral.eco/httpdocs/src/Trinity/NeutralBundle/Resources/views/front/projects/view-project-detail.html.twig");
    }
}
