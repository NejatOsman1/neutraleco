...
namespace App\CmsBundle\Classes\PhpOffice\PhpWord\Reader;
...
class Word2007 extends AbstractReader implements ReaderInterface
{
    ...
    {
        $partClass = "App\CmsBundle\\Classes\\PhpOffice\\PhpWord\\Reader\\Word2007\\{$partName}";
        if (class_exists($partClass)) {
            /** @var \App\CmsBundle\Classes\PhpOffice\PhpWord\Reader\Word2007\AbstractPart $part Type hint */
