...
abstract class AbstractStyle
{
    ...
    {
        if ($value !== null) {
            $class = 'CmsBundle\\Classes\\PhpOffice\\PhpWord\\Writer\\Word2007\\Style\\' . $name;

            /** @var \App\CmsBundle\Classes\PhpOffice\PhpWord\Writer\Word2007\Style\AbstractStyle $writer */
