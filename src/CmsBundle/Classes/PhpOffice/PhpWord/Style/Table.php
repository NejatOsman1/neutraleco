...
namespace App\CmsBundle\Classes\PhpOffice\PhpWord\Style;

use App\CmsBundle\Classes\PhpOffice\PhpWord\ComplexType\TblWidth as TblWidthComplexType;
use App\CmsBundle\Classes\PhpOffice\PhpWord\SimpleType\Jc;
use App\CmsBundle\Classes\PhpOffice\PhpWord\SimpleType\JcTable;
use App\CmsBundle\Classes\PhpOffice\PhpWord\SimpleType\TblWidth;

class Table extends Border
{
    /**
     * @deprecated Use \App\CmsBundle\Classes\PhpOffice\PhpWord\SimpleType\TblWidth::AUTO instead
     */
    const WIDTH_AUTO = 'auto'; // Automatically determined width
    /**
     * @deprecated Use \App\CmsBundle\Classes\PhpOffice\PhpWord\SimpleType\TblWidth::PERCENT instead
     */
    const WIDTH_PERCENT = 'pct'; // Width in fiftieths (1/50) of a percent (1% = 50 unit)
    /**
     * @deprecated Use \App\CmsBundle\Classes\PhpOffice\PhpWord\SimpleType\TblWidth::TWIP instead
     */
     ...
     * Style for first row
     *
     * @var \App\CmsBundle\Classes\PhpOffice\PhpWord\Style\Table
     */
     ...
     * Shading
     *
     * @var \App\CmsBundle\Classes\PhpOffice\PhpWord\Style\Shading
     */
    private $shading;
     ...
     * Position
     *
     * @var \App\CmsBundle\Classes\PhpOffice\PhpWord\Style\TablePosition
     */
    private $position;
     ...
     * Set first row
     *
     * @return \App\CmsBundle\Classes\PhpOffice\PhpWord\Style\Table
     */
     ...
     * Get shading
     *
     * @return \App\CmsBundle\Classes\PhpOffice\PhpWord\Style\Shading
     */
     ...
     * Get position
     *
     * @return \App\CmsBundle\Classes\PhpOffice\PhpWord\Style\TablePosition
     */
