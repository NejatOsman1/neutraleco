...
class __TwigTemplate_6637252f526011ef1e52e3a40f89604d7824fbd661aa92fe1405dbd591a19135 extends Template
{
    private $source;
    private $macros = [];
          ...
          <span>
            ...
            if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["firstBlock"] ?? null), "config", [], "any", false, true, false, 61), "buttons", [], "any", true, true, false, 61)) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["button"]) {
                    ...
                    echo "\" ";
                    if ((twig_get_attribute($this->env, $this->source, $context["button"], "target", [], "any", true, true, false, 63) && (0 !== twig_compare(twig_get_attribute($this->env, $this->source, $context["button"], "target", [], "any", false, false, false, 63), "null")))) {
                        echo " target=\"";
...
";
    ...
    {
        return new Source("", "@Cms/blocks/framework_cta_banner.html.twig", "/var/www/html/src/CmsBundle/Resources/views/blocks/framework_cta_banner.html.twig");
    }
}
