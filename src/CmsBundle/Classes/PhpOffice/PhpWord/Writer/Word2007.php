...
namespace App\CmsBundle\Classes\PhpOffice\PhpWord\Writer;

use App\CmsBundle\Classes\PhpOffice\PhpWord\Element\Section;
use App\CmsBundle\Classes\PhpOffice\PhpWord\Media;
...
class Word2007 extends AbstractWriter implements WriterInterface
{
     ...
     *
     * @param \App\CmsBundle\Classes\PhpOffice\PhpWord\PhpWord
     */
    public function __construct(PhpWord $phpWord = null)
    {
        ...
        foreach (array_keys($this->parts) as $partName) {
            ...
            if (class_exists($partClass)) {
                /** @var \App\CmsBundle\Classes\PhpOffice\PhpWord\Writer\Word2007\Part\AbstractPart $part Type hint */
                $part = new $partClass();
     ...
     *
     * @param \App\CmsBundle\Classes\PhpOffice\PhpWord\Shared\ZipArchive $zip
        ...
        if (!empty($elements)) {
            foreach ($elements as $file => $media) {
                if (count($media) > 0) {
                    ...
                    /** @var \App\CmsBundle\Classes\PhpOffice\PhpWord\Writer\Word2007\Part\AbstractPart $writerPart Type hint */
     ...
     *
     * @param \App\CmsBundle\Classes\PhpOffice\PhpWord\Element\Section &$section
     * @param \App\CmsBundle\Classes\PhpOffice\PhpWord\Shared\ZipArchive $zip
    ...
    private function addHeaderFooterContent(Section &$section, ZipArchive $zip, $elmType, &$rId)
    {
        ...
        /** @var \App\CmsBundle\Classes\PhpOffice\PhpWord\Element\AbstractElement $element Type hint */
    ...
    private function addNotes(ZipArchive $zip, &$rId, $noteType = 'footnote')
    {
        ...
        /** @var \App\CmsBundle\Classes\PhpOffice\PhpWord\Collection\AbstractCollection $collection Type hint */
    ...
    private function addChart(ZipArchive $zip, &$rId)
    {
        ...
        $index = 0;
        if ($collection->countItems() > 0) {
            /** @var \App\CmsBundle\Classes\PhpOffice\PhpWord\Element\Chart $chart */
