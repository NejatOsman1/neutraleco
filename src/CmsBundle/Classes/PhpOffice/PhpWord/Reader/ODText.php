...
class ODText extends AbstractReader implements ReaderInterface
{
    ...
    {
        $partClass = "App\CmsBundle\\Classes\\PhpOffice\\PhpWord\\Reader\\ODText\\{$partName}";
        if (class_exists($partClass)) {
            /** @var \App\CmsBundle\Classes\PhpOffice\PhpWord\Reader\ODText\AbstractPart $part Type hint */
