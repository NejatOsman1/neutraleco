...
class __TwigTemplate_e15313690111899f1f424fcd4ca283ee1e7bf63dea6ac1042aae334c4b4bae10 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t";
        ...
        echo "\" ";
        if ((twig_get_attribute($this->env, $this->source, ($context["Question"] ?? null), "required", [], "any", false, false, false, 11) && (0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["Question"] ?? null), "hidden", [], "any", false, false, false, 11), false)))) {
            echo "required=\"true\"";
        }
        echo " value=\"";
...
\t\t";
    ...
    {
        return new Source("", "@TrinityForms/elements/textarea.html.twig", "/var/www/html/src/Trinity/FormsBundle/Resources/views/elements/textarea.html.twig");
    }
}
