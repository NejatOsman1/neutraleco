...
use App\CmsBundle\Classes\PhpOffice\PhpWord\ComplexType\FootnoteProperties;
use App\CmsBundle\Classes\PhpOffice\PhpWord\Style\Section as SectionStyle;
...
class Section extends AbstractContainer
{
     ...
     * Section style
     *
     * @var \App\CmsBundle\Classes\PhpOffice\PhpWord\Style\Section
     */
    private $style;
    ...
    private function addHeaderFooter($type = Header::AUTO, $header = true)
    {
        ...
        if (in_array($type, array(Header::AUTO, Header::FIRST, Header::EVEN))) {
            ...
            /** @var \App\CmsBundle\Classes\PhpOffice\PhpWord\Element\AbstractContainer $container Type hint */
