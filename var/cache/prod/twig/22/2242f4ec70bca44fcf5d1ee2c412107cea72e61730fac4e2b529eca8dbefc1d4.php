...
class __TwigTemplate_863f1ae2b5b52d92aecb93ebeda71bae04cfe91200b46e9dbe7d8d693cebc923 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t  ";
                    // line 19
                    if ((( !array_key_exists("edit", $context) && twig_get_attribute($this->env, $this->source, ($context["Question"] ?? null), "required", [], "any", false, false, false, 19)) && (0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["Question"] ?? null), "hidden", [], "any", false, false, false, 19), false)))) {
...
\t\t\t\t\t\t\t";
                    // line 25
                    if ((( !array_key_exists("edit", $context) && twig_get_attribute($this->env, $this->source, ($context["Question"] ?? null), "required", [], "any", false, false, false, 25)) && (0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["Question"] ?? null), "hidden", [], "any", false, false, false, 25), false)))) {
                        echo "<span class=\"req\">*</span>";
                    }
                    // line 26
                    echo "\t\t\t\t\t\t</div>
\t\t\t\t\t";
            ...
            if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, ($context["Question"] ?? null), "getTitle", [], "any", false, false, false, 40))) {
                ...
                if ((( !array_key_exists("edit", $context) && twig_get_attribute($this->env, $this->source, ($context["Question"] ?? null), "required", [], "any", false, false, false, 41)) && (0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["Question"] ?? null), "hidden", [], "any", false, false, false, 41), false)))) {
                    echo "<span class=\"req\">*</span>";
                }
                echo "</div>
                ";
        ...
        if (twig_in_filter(twig_get_attribute($this->env, $this->source, ($context["Question"] ?? null), "getType", [], "any", false, false, false, 63), [0 => "select", 1 => "upload", 2 => "email", 3 => "email_check", 4 => "email_check", 5 => "text", 6 => "date", 7 => "textarea"])) {
            // line 64
            echo "                    ";
            if (((0 !== twig_compare(twig_striptags(twig_trim_filter(twig_get_attribute($this->env, $this->source, ($context["Question"] ?? null), "getSubTitle", [], "any", false, false, false, 64))), $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Toelichting", [], "forms"))) &&  !array_key_exists("edit", $context))) {
        ...
        if (array_key_exists("edit", $context)) {
            ...
            echo (((0 !== twig_compare(twig_striptags(twig_trim_filter(twig_get_attribute($this->env, $this->source, ($context["Question"] ?? null), "subtitle", [], "any", false, false, false, 98))), $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Toelichting", [], "forms")))) ? (twig_get_attribute($this->env, $this->source, ($context["Question"] ?? null), "subtitle", [], "any", false, false, false, 98)) : (""));
            echo "\">
                                        </p>
                                    </div>
                                </div>
            ...
            echo (((twig_get_attribute($this->env, $this->source, ($context["Question"] ?? null), "required", [], "any", false, false, false, 109) && (0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["Question"] ?? null), "hidden", [], "any", false, false, false, 109), false)))) ? ("checked=\"checked\"") : (""));
...
\t\t\t\t\t\t\t<a href=\"#\" data-toggle=\"true\" onclick=\"if (\$(this).find('i').html() == 'check_box') {
                ...
                // line 157
                echo (((twig_get_attribute($this->env, $this->source, ($context["Question"] ?? null), "required", [], "any", false, false, false, 157) && (0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["Question"] ?? null), "hidden", [], "any", false, false, false, 157), false)))) ? ("check_box") : ("check_box_outline_blank"));
                echo "</i>";
...
";
    ...
    {
        return new Source("", "@TrinityForms/elements/row.html.twig", "/var/www/html/src/Trinity/FormsBundle/Resources/views/elements/row.html.twig");
    }
}
