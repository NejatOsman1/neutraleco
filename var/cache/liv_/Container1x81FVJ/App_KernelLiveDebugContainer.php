...
class App_KernelLiveDebugContainer extends Container
{
    ...
    protected function getHubInterfaceService()
    {
        ...
        $a->setPrefixes([0 => (\dirname(__DIR__, 4).'/vendor/phing/phing/classes'), 1 => (\dirname(__DIR__, 4).'/vendor/propel/propel1/runtime/lib'), 2 => (\dirname(__DIR__, 4).'/vendor/propel/propel1/generator/lib'), 3 => \dirname(__DIR__, 4), 4 => '/usr/share/php']);
