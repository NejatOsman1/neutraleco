...
namespace App\CmsBundle\Classes\PhpOffice\PhpWord;

use App\CmsBundle\Classes\PhpOffice\Common\Text;
use App\CmsBundle\Classes\PhpOffice\Common\XMLWriter;
use App\CmsBundle\Classes\PhpOffice\PhpWord\Escaper\RegExp;
use App\CmsBundle\Classes\PhpOffice\PhpWord\Escaper\Xml;
use App\CmsBundle\Classes\PhpOffice\PhpWord\Exception\CopyFileException;
use App\CmsBundle\Classes\PhpOffice\PhpWord\Exception\CreateTemporaryFileException;
use App\CmsBundle\Classes\PhpOffice\PhpWord\Exception\Exception;
use App\CmsBundle\Classes\PhpOffice\PhpWord\Shared\ZipArchive;
...
class TemplateProcessor
{
     ...
     *
     * @throws \App\CmsBundle\Classes\PhpOffice\PhpWord\Exception\CreateTemporaryFileException
     * @throws \App\CmsBundle\Classes\PhpOffice\PhpWord\Exception\CopyFileException
     */
     ...
     *
     * @return \App\CmsBundle\Classes\PhpOffice\PhpWord\Shared\ZipArchive
     */
    public function zip()
    {
     ...
     *
     * @throws \App\CmsBundle\Classes\PhpOffice\PhpWord\Exception\Exception
     *
     * @return string
     */
    ...
    /**
     * @param string $search
     * @param \App\CmsBundle\Classes\PhpOffice\PhpWord\Element\AbstractElement $complexType
     */
    public function setComplexValue($search, \App\CmsBundle\Classes\PhpOffice\PhpWord\Element\AbstractElement $complexType)
    {
        $elementName = substr(get_class($complexType), strrpos(get_class($complexType), '\\') + 1);
        $objectClass = 'CmsBundle\\Classes\\PhpOffice\\PhpWord\\Writer\\Word2007\\Element\\' . $elementName;

        $xmlWriter = new XMLWriter();
        /** @var \App\CmsBundle\Classes\PhpOffice\PhpWord\Writer\Word2007\Element\AbstractElement $elementWriter */
     ...
     * @param \App\CmsBundle\Classes\PhpOffice\PhpWord\Element\AbstractElement $complexType
     */
    public function setComplexBlock($search, \App\CmsBundle\Classes\PhpOffice\PhpWord\Element\AbstractElement $complexType)
    {
        $elementName = substr(get_class($complexType), strrpos(get_class($complexType), '\\') + 1);
        $objectClass = 'CmsBundle\\Classes\\PhpOffice\\PhpWord\\Writer\\Word2007\\Element\\' . $elementName;
     ...
     * @return \App\CmsBundle\Classes\PhpOffice\PhpWord\TemplateProcessor Fluent interface
     */
